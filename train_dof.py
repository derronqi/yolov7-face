...
def train(hyp, opt, device, tb_writer=None):
    ...
    dataloader, dataset = create_dataloader_lmdb(train_path, imgsz, batch_size, gs, opt,
    ...
    # Process 0
    if rank in [-1, 0]:
        testloader = create_dataloader_lmdb(test_path, imgsz_test, batch_size * 2, gs, opt,  # testloader
