...
class ONNX_TRT_FACE(nn.Module):
    '''onnx module with TensorRT NMS operation.'''
    def __init__(self, max_obj=100, iou_thres=0.45, score_thres=0.25, max_wh=None ,device=None, n_classes=1):
        super().__init__()
...
class End2End(nn.Module):
    ...
    def __init__(self, model, max_obj=100, iou_thres=0.45, score_thres=0.25, max_wh=None, device=None, n_classes=80):
        ...
        self.patch_model = ONNX_TRT_FACE if max_wh is None else ONNX_ORT
